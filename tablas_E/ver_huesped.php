                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex gap-2">
                                <a class="bg-yellow-400 hover:bg-yellow-500 text-black px-3 py-1 rounded-full text-xs font-semibold shadow-md transition-transform hover:scale-105" href="../empleado/editar_registro_E.php?id=<?= $row['id_huesped']?>">Editar</a>
                            </div> 
                        </td>
                    </tr>
                <?php } ?>
