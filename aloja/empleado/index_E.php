            ...
            <ul class="nav d-flex flex-row flex-lg-column navegador">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="ver_tablas_E.php">Ver datos</a></li>
              ...
              <div class="col">
                <div class="card habitacion1 text-white">
                  ...
                  <div class="card-body">
                    ...
                    <button class="btn btn-primary" data-bs-toggle="modal2" data-bs-target="#modal<?php echo $row['id_habitacion']; ?>">Ver más</button>
                  </div>
                </div>
              </div>

              <!-- Modal -->
              <div class="modal fade" id="modal2<?php echo $row['id_habitacion']; ?>" tabindex="-1" aria-labelledby="modalLabel2<?php echo $row['id_habitacion']; ?>" aria-hidden="true">
