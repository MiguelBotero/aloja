    ...
    <body class="bg-gray-200 text-gray-800 min-h-screen">
        <div>
            ...
            <header class="bg-gradient-to-r from-gray-950 via-indigo-950 to-blue-950 px-8 py-6 text-white shadow-xl">
                <div class="flex justify-between items-center">
                    ...
                    <div class="text-left">
                        ...
                        <p class="text-sm text-indigo-200">Gestión de registros</p>
                    </div>
                    </div>
            ...
            <main class="p-8"> 
                ...
                <div class="bg-white rounded-xl shadow-lg p-6 max-w-3xl mx-auto mt-8">
                    <label for="formSelect" class="block text-left text-lg text-gray-700 mb-2 font-bold">
                        Seleccione el formulario que deseas ver:
                    </label>
                    <select id="formSelect" class="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500">
                ...
                <div id="huesped" class="formulario max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-lg">
                    <form id="formHuesped" action="../php/guardar_registro.php" method="POST" novalidate>
                ...
                <div id="habitacion" class="formulario max-w-4xl mx-auto bg-white p-6 rounded-xl shadow-lg mt-6 hidden">
                    <form id="formHabitacion" action="../php/guardar_habitacion.php" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-2 gap-6" novalidate>
                        <!-- Notificación general -->
                ...
                <div id="empleados" class="formulario hidden max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-lg mt-6">
                    <form id="formEmpleado" action="../php/guardar_empleado.php" method="POST" novalidate>
                        <!-- Notificación general -->
                        <div id="notificacion" class="hidden bg-red-100 text-red-800 text-center p-2 rounded mb-4 font-semibold shadow"></div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                <label for="nombre_completo" class="block text-gray-700 font-semibold mb-1">Nombre completo</label>
                                <input type="text" id="nombre_C" name="nombre_completo" required minlength="3" pattern="[A-Za-z\s]+"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500">
                                <p id="error-nombre_completo" class="text-sm text-red-600 mt-1 hidden">❗ Ingrese un nombre válido (solo letras y mínimo 3 caracteres).</p>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" id="usuario" name="usuario" required minlength="3"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500">
                                <p id="error-usuario" class="text-sm text-red-600 mt-1 hidden">❗ Ingrese un nombre de usuario válido (mínimo 3 caracteres).</p>
                            </div>
                            ...
                            <div class="mb-4 md:col-span-2">
                                ...
                                <input type="password" id="password" name="password" required minlength="6"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500">
                                <p id="error-password" class="text-sm text-red-600 mt-1 hidden">❗ La contraseña debe tener mínimo 6 caracteres.</p>
                            </div>
                        </div>
                ...
                <div id="estadia" class="formulario hidden max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-lg mt-6">
                    <form id="formEstadia" action="../php/guardar_estadia.php" method="POST" novalidate>
                        <!-- Notificación general -->
                        <div id="notificacion" class="hidden bg-red-100 text-red-800 text-center p-2 rounded mb-4 font-semibold shadow"></div>
                ...
                <div id="novedades" class="formulario hidden max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-lg mt-6">
                    <form id="formNovedad" action="../php/guardar_novedades.php" method="POST" novalidate>
                        <!-- Notificación general -->
                        <div id="notificacion" class="hidden bg-red-100 text-red-800 text-center p-2 rounded mb-4 font-semibold shadow"></div>
                ...
                <div id="huesped_has_estado" class="formulario hidden max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-lg mt-6">
                    <form action="../php/guardar_huesped_has_estado.php" method="POST" id="formHuespedHasEstado">
                        <!-- Notificación general -->
                        <div id="notificacion" class="hidden bg-red-100 text-red-800 text-center p-2 rounded mb-4 font-semibold shadow"></div>
                ...
                <div id="pago" class="formulario hidden max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-lg">
                    <form action="../php/guardar_pagos.php" method="POST" id="formPago" novalidate>
                        <!-- Notificación general -->
                        <div id="notificacion" class="hidden bg-red-100 text-red-800 text-center p-2 rounded mb-4 font-semibold shadow"></div>
                ...
                <div id="tarifas" class="formulario hidden max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-lg">
                    <form action="../php/guardar_tarifas.php" method="POST" id="formTarifas" novalidate>
                        <!-- Notificación general -->
                        <div id="notificacion" class="hidden bg-red-100 text-red-800 text-center p-2 rounded mb-4 font-semibold shadow"></div>
                        ...
                        <div class="mb-4">
                            ...
                            class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500">
                            <p class="text-sm text-red-600 mt-1 hidden" id="error-dia">❗ Ingrese una tarifa diaria válida.</p>
                        </div>

                        <!-- Semana -->
                        <div class="mb-4">
                            <label for="semana" class="block text-gray-700 font-semibold mb-1">Semana</label>
                            <input type="text" name="semana" id="semana" required
                            class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500">
                            <p class="text-sm text-red-600 mt-1 hidden" id="error-semana">❗ Ingrese una tarifa semanal válida.</p>
                        </div>

                        <!-- Quincena -->
                        <div class="mb-4">
                            <label for="quincena" class="block text-gray-700 font-semibold mb-1">Quincena</label>
                            <input type="number" name="quincena" id="quincena" required min="1"
                            class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500">
                            <p class="text-sm text-red-600 mt-1 hidden" id="error-quincena">❗ Ingrese una tarifa quincenal válida.</p>
                        </div>

                        <!-- Mensual -->
                        <div class="mb-4">
                            <label for="mensual" class="block text-gray-700 font-semibold mb-1">Mensual</label>
                            <input type="number" name="mensual" id="mensual" required min="1"
                            class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-indigo-500">
                            <p class="text-sm text-red-600 mt-1 hidden" id="error-mensual">❗ Ingrese una tarifa mensual válida.</p>
                        </div>

                        <!-- ID Habitación -->
                        <div class="mb-4">
                            <label for="id_habitacion2" class="block text-gray-700 font-semibold mb-1">ID Habitación</label>
                            ...
                            <p class="text-sm text-red-600 mt-1 hidden" id="error-id_habitacion2">❗ Seleccione una habitación.</p>
                        </div>
                ...
                <div id="otroingreso" class="formulario hidden max-w-3xl mx-auto bg-white p-6 rounded-xl shadow-lg">
                    <form action="../php/guardar_otro_ingreso.php" method="POST" id="formOtroIngreso" novalidate>
                        <!-- Notificación general -->
                        <div id="notificacion" class="hidden bg-red-100 text-red-800 text-center p-2 rounded mb-4 font-semibold shadow"></div>
