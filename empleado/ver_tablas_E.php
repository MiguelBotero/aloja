...
<html lang="es">
  ...
  <body class="bg-gray-300 text-white min-h-screen flex flex-col">
      ...
      <div class="flex justify-between items-center">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-indigo-200">Ver tablas</p>
          </div>
        </div>
  ...
  <main>
    ...
    <div class="p-6 max-w-7xl mx-auto">
      <div class="bg-white rounded-xl shadow-lg p-6 mb-8 text-black">
      ...
      <div class="space-y-10">
        <div id="tabla_huesped" class="tabla-contenido">
          <div class="bg-white rounded-lg shadow p-4">
            ...
            <?php include '../tablas_E/ver_huesped.php'; ?>
          </div>
        </div>
        ...
        <div id="tabla_estadia" class="tabla-contenido hidden">
          <div class="bg-white rounded-lg shadow p-4">
            ...
            <?php include '../tablas_E/ver_estadia.php'; ?>
          </div>
        </div>
        ...
        <div id="tabla_novedades" class="tabla-contenido hidden">
          <div class="bg-white rounded-lg shadow p-4">
            ...
            <?php include '../tablas_E/ver_novedades.php'; ?>
          </div>
        </div>
        ...
        <div id="tabla_huesped_has_estado" class="tabla-contenido hidden">
          <div class="bg-white rounded-lg shadow p-4">
            ...
            <?php include '../tablas_E/ver_huesped_has_estado.php'; ?>
          </div>
        </div>
        ...
        <div id="tabla_pagos" class="tabla-contenido hidden">
          <div class="bg-white rounded-lg shadow p-4">
            ...
            <?php include '../tablas_E/ver_pagos.php'; ?>
          </div>
        </div>
        ...
        <div id="tabla_tarifas" class="tabla-contenido hidden">
          <div class="bg-white rounded-lg shadow p-4">
            ...
            <?php include '../tablas_E/ver_tarifa.php'; ?>
          </div>
        </div>
        ...
        <div id="tabla_otroingreso" class="tabla-contenido hidden">
          <div class="bg-white rounded-lg shadow p-4">
            ...
            <?php include '../tablas_E/ver_otros_ingresos.php'; ?>
          </div>
        </div>
