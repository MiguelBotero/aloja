            ...
            <?php while ($row = mysqli_fetch_assoc($resultado)) { ?>
                <tr>
                    ...
                    <td class="flex flex-wrap gap-2">
                        <a class="bg-yellow-400 hover:bg-yellow-500 text-black px-4 py-1 rounded-full text-sm font-semibold shadow-md transition-transform hover:scale-105" href="../empleado/editar_otroingresos_E.php?id=<?= $row['id_otroingreso']?>"  style="">Editar</a>
