...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt) {
        mysqli_stmt_bind_param($stmt, "sssdisii", $nombre, $dotacion, $telefono_encargado, $precio, $disponibilidad, $imagen_final,$rebaja, $id);
        ...
        if (mysqli_stmt_execute($stmt)) {
            ...
            echo "<script>
                Swal.fire({
                    ...
                    window.location.href = '../administrador/editar_habitacion.php';
                });
            </script>";
        }
